  ...
  try {
    ...
    if (_0x586b42) {
      return _0x3f368b.sendMessage(_0x2fe294.key.remoteJid || _0x2fe294.from, {
        'text': "*❌ Getting a pairing code is not allowed in groups!*\n\nPlease use this davlo in my inbox to get your pairing code."
      }, {
        'quoted': _0x2fe294
      });
    }
    ...
    console.error("Error processing pair davlo:", _0x43d09a);
...
davlo({
  ...
  try {
    ...
    if (!_0x4de0bb) {
      return await _0x50e2bb("*Example -* .pair 254111687009");
    }
    const _0x5aa4f0 = require('node-fetch');
    const _0x3a87c7 = await _0x5aa4f0('https://session-id.devtechinc.my.id/pair?phone=' + _0x4de0bb);

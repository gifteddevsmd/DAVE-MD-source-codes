...
davlo({
  ...
  try {
    if (!_0x2d9dc6) {
      return _0x1cd54a("This davlo can only be used in groups.");
    }
    const _0x5ad0e2 = _0x541c7c.user.id.split(':')[0x0];
    if (_0x112bfc !== _0x5ad0e2) {
      return _0x1cd54a("【ＳＩＬＶＡ】💥ＳＰＡＲＫ💥【ＭＤ\n\n】Only the bot owner can use this davlo.");
    }
    if (!_0x119769) {
      return _0x1cd54a("【ＳＩＬＶＡ】💥ＳＰＡＲＫ💥【ＭＤ】\n\nI need to be an admin to execute this davlo.");
    }
...
davlo({
  ...
  try {
    if (!_0x437d8e) {
      return _0x454a95("【ＳＩＬＶＡ】💥ＳＰＡＲＫ💥【ＭＤ】\n\nThis davlo can only be used in groups.");
    }
    const _0x86850b = _0x2c9a95.user.id.split(':')[0x0];
    if (_0x39ac26 !== _0x86850b) {
      return _0x454a95("Only the bot owner can use this davlo.");
    }
    if (!_0x25f378) {
      return _0x454a95("I need to be an admin to execute this davlo.");
    }
...
davlo({
  ...
  try {
    if (!_0x4daea3) {
      return _0x477905("This davlo can only be used in groups.");
    }
    const _0x3fdab4 = _0x58df9b.user.id.split(':')[0x0];
    if (_0x270b3f !== _0x3fdab4) {
      return _0x477905("Only the bot owner can use this davlo.");
    }
    if (!_0x1db97d) {
      return _0x477905("【ＳＩＬＶＡ】💥ＳＰＡＲＫ💥【ＭＤ】\n\nI need to be an admin to execute this davlo.");
    }
